...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='ScanObjectNN_hardest', metavar='N',
    ...
    parser.add_argument('--model_path', type=str, default='./models/model_scanobj_hardest.t7', metavar='N',
