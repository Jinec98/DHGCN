...
def test(args):
    ...
    model = LinearClassifier(args, output_channels=40).to(device)
    print(str(model))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_name', default='DHGCN_unsupervised_test', type=str, metavar='N', required=False,
    ...
    parser.add_argument('--model_path', type=str, default='./models/model_linear_adapt_sn.t7', metavar='N',
                        help='Pretrained model path')
    parser.add_argument('--resume', type=bool, default=True, metavar='N',
                        help='Restore model from path')
    # ---------------------------------------------------------
    parser.add_argument('--backbone', type=str, default='AdaptConv', metavar='N',
                        choices=['DGCNN', 'AdaptConv']) 
