...
class ShapeNetPart():
    def __init__(self, root, config, num_points=1024, split='train', normalize=True,  split_num=3):
    ...
    def __getitem__(self, index):
        ...
        return cat, obj_id, point_set, seg, mask, onehot, p2v_indices, part_distance, part_rand_idx
...
if __name__ == '__main__':
    data = ShapeNetPart(root='./data/shapenetcore_partanno_segmentation_benchmark_v0_normal', config=PartSegConfig(), split='trainval', num_points=1024)
